...
SUPPORTED_ARTICLE_URL_PATTERN = re.compile(
    ...
    r"(?:www\.)?xiaohongshu\.com/(?:explore|discovery/item)/[0-9a-fA-F]{24}/?"
    r"(?:\?[^\s<>\"']*)?|"
    r"xhslink\.(?:cn|com)/[A-Za-z0-9_/-]+/?(?:\?[^\s<>\"']*)?|"
    r"(?:(?:www|m)\.)?bilibili\.com/video/BV[A-Za-z0-9]{10}(?![A-Za-z0-9])/?"
    r"(?:\?[^\s<>\"']*)?|"
    r"b23\.tv/[A-Za-z0-9_-]+/?(?:\?[^\s<>\"']*)?|"
